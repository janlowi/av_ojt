...
include '../Layouts/main-admin.php'; 
 ...
 <tr class="table-white">
     ...
     <div class="row">
        ...
        <div class= "col">
        <a class="dropdown-item" href="../Timesheet/DisplayUserAttendance.php?trainee_attendance=<?=$row['id'] ?>"> <button class= "btn btn-info " data-bs-toggle="tooltip" data-bs-placement="top" title="View attendance records"><i class='fa fa-user-circle'></i> </button></a>
