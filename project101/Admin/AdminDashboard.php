                                               ...
                                               <div class="card-body">
                                                       ...
                                                       <div class="row g-3">
                                                        ...
                                                        <div class="row g-3">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                       <label for="inputLastname" class="form-label">Usertype</label>
                                                                       <input type="text" class="form-control" id="inputLastname"name = "Usertype" value="Manager" readonly>
                                                                        </div>
                                                                 ...
                                                                 ?>
                                                                       ...
                                                                       <input type="date" class="form-control" id="inputCity"name = "Birthday" required>
                                                                        ...
                                                                        <div>
                                                                        <div class=" d-grid gap-2 col-6 mx-auto ">
                                                                        <button id="register-btn" type="submit" name ="managerSubmit"class="btn btn-dark ">Register</button>
                                                                        </div>  
                                                                        </div>
