...
// Function to fetch time in
function fetchTimeIn($connect, $user_id) {
...
if ($user_id) {
    // Call the function to fetch time in
    $timeIn = fetchTimeIn($connect, $user_id);
    echo "Time in: " . $timeIn;
} else {
    echo ".";
}
...
<body>
    <div class="time-box" onclick="displayTime()">
        <p class="time-description">Time In</p>
